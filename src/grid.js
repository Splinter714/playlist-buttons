...
//
// ---------------------------------------------------------------------------------
// There is no edit mode here, and that is the point
// ---------------------------------------------------------------------------------
// Reordering used to live on this screen behind a mode that turned tap-to-play off
// (#3). It now lives on the settings screen, where the rotation is already decided,
// dragged by a handle on each member's row. That leaves this file with ONE kind of
// tile and NO `preventDefault` anywhere in it — every tile on this screen is a live
// link, always, which is exactly what #4's on-device spike found matters: suppressing
// or synthesising navigation is what can bring iOS's "Open in Shortcuts?" prompt back.
//
// So: nothing here suppresses a tap, and nothing here has a mode to get stuck in.
